    ...
    <div class="row justify-content-around">
        <form class="col-12 col-md-6 card m-3" method="POST" action="{{ route("comics.store") }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="manga-price" name="price">
            </div>
            <div class="mb-3">
                <label for="manga-thumb" class="form-label">Ulr immagine:</label>
                <input type="text" class="form-control" id="manga-thumb" name="thumb">
            </div>
            <div class="mb-3">
                <label for="manga-author" class="form-label">Autore:</label>
                <input type="text" class="form-control" id="manga-author" name="author">
            </div>
